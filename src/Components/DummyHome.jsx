import { useDisclosure, Button, Modal, ModalOverlay, ModalContent, ModalHeader, ModalFooter, ModalBody, ModalCloseButton, Text } from "@chakra-ui/react";
      ...
      <div>
        ...
        <div className="slider">
          <div className="slider-content">
            ...
            <Button onClick={openModal} colorScheme='transparent' border="1px solid white" >Learn More</Button>
          </div>
        </div>
